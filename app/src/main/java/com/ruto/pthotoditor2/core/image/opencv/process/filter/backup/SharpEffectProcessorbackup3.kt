...
object SharpEffectProcessorbackup3 {
    ...
    fun apply(bitmap: Bitmap): Bitmap {
        ...
        val resultMat = applyDetailSharpening(src, sharpnessLevel = 1.8)
...
//            Imgproc.GaussianBlur(bgr, blurred, Size(0.0, 0.0), 0.0)
            // Median Blur로 좀 더 노이즈 억제
            Imgproc.medianBlur(bgr, blurred,1)
            ...
            clipped = clipRGBRange(sharpened, min = 1.0, max = 250.0)
