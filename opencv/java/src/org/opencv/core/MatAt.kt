...
class AtableUByte(val mat: Mat, val indices: IntArray): Atable<UByte> {
    ...
    override fun setV3c(v: Tuple3<UByte>) {
        val data = ubyteArrayOf(v._0.toUByte(), v._1.toUByte(), v._2.toUByte())
        mat.put(indices, data)
    }
    ...
    override fun setV4c(v: Tuple4<UByte>) {
        val data = ubyteArrayOf(v._0.toUByte(), v._1.toUByte(), v._2.toUByte(), v._3.toUByte())
        mat.put(indices, data)
    }
}
...
class AtableUShort(val mat: Mat, val indices: IntArray): Atable<UShort> {
    ...
    override fun setV2c(v: Tuple2<UShort>) {
        val data = ushortArrayOf(v._0.toUShort(), v._1.toUShort())
        mat.put(indices, data)
    }
    ...
    override fun setV3c(v: Tuple3<UShort>) {
        val data = ushortArrayOf(v._0.toUShort(), v._1.toUShort(), v._2.toUShort())
        mat.put(indices, data)
    }
    ...
    override fun setV4c(v: Tuple4<UShort>) {
        val data = ushortArrayOf(v._0.toUShort(), v._1.toUShort(), v._2.toUShort(), v._3.toUShort())
        mat.put(indices, data)
    }
}
